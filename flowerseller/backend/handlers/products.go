...
func (h *Handler) CreateProduct(w http.ResponseWriter, r *http.Request) {
	...
	var id string
	err := h.pool.QueryRow(r.Context(),
		`INSERT INTO products (name, type, category_id, base_price, description, disposal_days)
VALUES ($1,$2,$3,$4,$5,$6) RETURNING id`,
		body.Name, body.Type, body.CategoryID, body.BasePrice, body.Description, body.DisposalDays).Scan(&id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
