...
/** 販売者・仲介者: 入荷出費（UIは生産者の売れ行きと同じ：グラフ＋本日一覧） */
export default async function InboundExpensesPage() {
  ...
  return (
    <div className={pageContainer}>
      ...
      <section className="mb-8" aria-labelledby="inbound-expenses-graph-heading">
        <SalesGraph
          data={graphData}
          sales={salesList}
      ...
      <section aria-labelledby="inbound-expenses-today-heading">
        <h3 id="inbound-expenses-today-heading" className="text-base font-semibold text-text mb-3">
          本日の入荷出費
        </h3>
